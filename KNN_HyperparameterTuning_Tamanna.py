...
# Loading previously saved variables using joblib
...
def KNN_model(x_train, x_test, y_train, y_test):
    """
    Implementing KNN model, evaluating its performance, and visualizing results.
...
# # Evaluatoing Model Performance After Feature Scaling
